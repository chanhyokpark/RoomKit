...
3. 개발 서버 URL을 가리키는 웹사이트 애셋과 해당 장치로 이동하는 테스트용 이벤트를 만들어 주세요.
4. Player를 실행하고 Studio에서 Player를 선택해 **테스트 세션**을 만든 뒤 세션을 시작해 주세요.
5. 웹사이트 이동 이벤트를 실행하고 만든 힌트 코드를 입력해 주세요.
